          ...
          <RowFlexedContainer2 style={{ flexDirection: 'column', justifyContent:'flex-start', alignItems: "center", minHeight: '40vh' }}>
            {isLoading ? <p>Loading...</p> : 
              <>
                ...
                <RowFlexedContainerForm onSubmit={ e => { e.preventDefault(); updateUser(selectedUser._id); }} style={{ background: 'white', padding: '20px', border: '1px solid #cccccc', borderRadius: '5px' }}>
                  <div className="left">
