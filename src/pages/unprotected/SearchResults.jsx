...
export default function Schedules() {
  ...
  const { searchOption: bookingSearchOption, listOfBookings, searchBookingsResults, numberOfBookingsResults, isLoading } = useSelector(state => state.booking);
  const { searchOption: userSearchOption, listOfDJs, searchUserResults, numberOfUserResults } = useSelector(state => state.user);
